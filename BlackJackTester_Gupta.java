        ...
        switch(state)
        {
            case TITLE_SCREEN:
                ...
                if (loggedIn == true)
                {
                    ...
                    if (state1 == "r") //when start button is pressed, returns r for room select
                        {
   ...
   public Blackjack()
   {
      ...
      while (playerCount <= 0 || playerCount > 4)
      {
         ...
         if (scanner.hasNextInt())
         {
            ...
            {
                System.out.println("Please enter a max of 4 players");
            }
            scanner.nextLine();
         }
         else
